...
public class MainTestPt1 {
	...
	public static void main(String[] args) throws Exception {
		...
		blog.comentarEntrada("pere@marianao.lan", new Date(), "I Cicero",
				"Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit,... ", 3);
		blog.comentarEntrada("pere@marianao.lan", new Date(), "I Cicero",
				"...sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.", 3);
		blog.comentarEntrada("pere@marianao.lan", new Date(), "II Cicero",
				"Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, "
						+ "adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.",
				2);
		blog.comentarEntrada("maria@marianao.lan", new Date(), "I Cicero",
				"Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit ", 2);
		blog.comentarEntrada("maria@marianao.lan", new Date(), "I Cicero",
				"laboriosam, nisi ut aliquid ex ea commodi consequatur?", 2);

		// blog.carregarDadesBlog(BLOG_FILENAME);

		System.out.println(blog.imprimirBlog());

		// System.out.println(blog.imprimirEntrada(new Date(), "Lorem ipsum
		// infinitum"));
